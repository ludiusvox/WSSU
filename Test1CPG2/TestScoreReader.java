...
/**
 * The TestScpreReader c;ass reads test scores as
 * tokens from a file and calculates the average of each line of scores
 */
public class TestScoreReader
{
        ...
        /**
         * The getAverage method calculates the average of the last set of test scores read from the file.
         * 
         * 
         */
